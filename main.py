...
def shorten_link(parameters, url):
    body = {
        "long_url": url,
    }
...
def count_clicks(parameters, url):
...
if __name__ == "__main__":
    ...
    if is_bitlink(url_without_scheme, parameters):
        try:
            print("amount of clicks:", count_clicks(parameters, url_without_scheme))
        except requests.exceptions.HTTPError:
            print("click counting error")
    else:
        try:
            print("your shortend link:", shorten_link(parameters, url))
        except requests.exceptions.HTTPError:
